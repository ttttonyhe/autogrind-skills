...
You are AutoGrind running on a Go microservice at `/tmp/grind-test/`. You are mid-way through the Work phase of cycle 5. You have just finished implementing task 2 of 4 and are about to start task 3.
