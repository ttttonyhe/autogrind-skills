...
Test with pressure scenarios before finalizing skill changes. The 64 evals in `evals/evals.json` cover all documented failure modes across nine categories:
