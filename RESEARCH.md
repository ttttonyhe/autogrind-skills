...
- **Pressure-scenario testing** — before each release, the skill is tested against adversarial inputs: false completion, time pressure, praise, empty backlog, explicit stop, retracted stop, stop-with-praise. All scenarios must pass
